...
ALTER TABLE ROOMTYPES ADD CONSTRAINT ROOMTYPES_FK0 FOREIGN KEY (HOTEL_ID) REFERENCES HOTELS(ID);

ALTER TABLE ROOMS ADD CONSTRAINT ROOMS_FK0 FOREIGN KEY (HOTEL_ID) REFERENCES HOTELS(ID);
ALTER TABLE ROOMS ADD CONSTRAINT ROOMS_FK1 FOREIGN KEY (ROOM_TYPE_ID) REFERENCES ROOMTYPES(ID);
